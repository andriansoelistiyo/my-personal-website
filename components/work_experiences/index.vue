      ...
      experiences: [
        {
          ...
          task_3: 'Wireframing, designing, and prototyping website app, mobile app, and tablet app',
          task_4: 'Do usability testing with user using useberry app',
          task_5: 'Create design system for website app, mobile app, and tablet app',
          task_6: 'Create documentation for all design process',
          task_7: 'Collaboration with front end dev to define components, template, and layout',
          task_8: 'Craete visual data using Google Data Studio',
          task_9: '',
          task_10: '',
          task_11: '',
          task_12: '',
